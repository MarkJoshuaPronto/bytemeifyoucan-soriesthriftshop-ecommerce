...
<main class="main">
    <div class="page-header text-center" style="background-image: url('{{ url('') }}/styles/images/page-header-bg.jpg')">
        <div class="container">
...
@section('script')
    ...
    <script src="{{ url('styles/js/wNumb.js') }}"></script>
    <script src="{{ url('styles/js/bootstrap-input-spinner.js') }}"></script>
    <script src="{{ url('styles/js/nouislider.min.js') }}"></script>
