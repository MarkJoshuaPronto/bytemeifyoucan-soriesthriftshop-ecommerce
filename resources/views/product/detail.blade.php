@extends('layouts.app')
@section('style')
    <link rel="stylesheet" href="{{ url('styles/css/plugins/nouislider/nouislider.css') }}">
@endsection
@section('content')
<main class="main">
    @if(session('error'))
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
        <div class="container d-flex align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ url($getProduct->getCategory->slug.'/'.$getProduct->getCategory->slug) }}">{{ $getProduct->getSubCategory->name }}</a></li>
                        ...
                        <form action="{{ url('product/add-to-cart') }}" method="post">
                            ...
                            <div class="product-details-footer">
                                <div class="product-cat">
                                    ...
                                    <a href="{{ url($getProduct->getCategory->slug.'/'.$getProduct->getCategory->slug) }}">{{ $getProduct->getSubCategory->name }}</a>
                                </div>
...
@section('script')
    ...
    <script src="{{ url('styles/js/bootstrap-input-spinner.js') }}"></script>
    <script src="{{ url('styles/js/jquery.elevateZoom.min.js') }}"></script>
    <script src="{{ url('styles/js/bootstrap-input-spinner.js') }}"></script>
