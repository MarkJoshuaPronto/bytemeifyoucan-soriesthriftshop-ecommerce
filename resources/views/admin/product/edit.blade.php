                                    ...
                                    @foreach($product->getImage as $image)
                                        @if(!empty($image->getLogo()))
                                            <div class="col-md-1 sortable_image" id="{{ $image->id }}" style="text-align: center;">
                                                ...
                                                <a onclick="return confirm('Are you sure you want to delete?');" href="{{ url('admin/product/image_delete/'.$image->id) }}" style="margin-top: 10px;" class="btn btn-danger btn-small">Delete</a>
                                            </div>
                                        @endif
                                    @endforeach
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" required>
                                            <option {{ (old($product->status) == 0) ? 'selected' : '' }} value="0">Active</option>
                                            <option {{ (old($product->status) == 1) ? 'selected' : '' }} value="1">Inactive</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/tinymce/5.10.3/jquery.tinymce.min.js" referrerpolicy="origin"></script>
...
$('.editor').tinymce({
        height: 500,
        apiKey: 'iq8zr4aolj9s606kmb31z2bvm6i2oelrgt0oesoo5q815uv9',
        menubar: false,
        plugins: [
